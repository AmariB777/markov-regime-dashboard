...
class MarkovRegime:
    ...
    def calibrate(self, hist_bars):
        ...
        for regime in range(self.n_states):
            ...
            if len(regime_vols) >= 3:
                ...
                self.emission_std[regime] = max(np.std(regime_vols), 1e-6)
        ...
        print(f'Calibrated emission stds: {self.emission_means}')
    ...
    def get_regime(self, bars):
        ...
        # Step 2 Compute emission likelihoods (Probabitlity of observing the spot vol | regime)
...
class LiveMarketDashboard:
    ...
    def setup_ui(self):
        ...
        self.connect_button = ttk.Button(conn_section, text="Connect", command=self.connect_ib)
        ...
        symbol_entry = ttk.Entry(data_section, textvariable=self.symbol_var,
                                 width=12, font=('JetBrains Mono', 11))
